...
/**
 * Adapts the ListController to a JList ListModel. 
 */
public final class JListListControllerAdapter<T extends ExtendedBean> extends AbstractListControllerAdapter<T> {
    private JList list;
