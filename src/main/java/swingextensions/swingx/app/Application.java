 ...
 * </ol>
 * <p>
 * Concrete implementations need only override getApplicationName, but will undoubtedly
...
public abstract class Application implements Thread.UncaughtExceptionHandler {
    public static final String APP_RESOURCES_PREFIX = "src/main/resources/";
    ...
    public String getResourceBundleName() {
    	return getClass().getPackage().getName() + ".application";
    }
    ...
    protected void installLookAndFeel() {
        try {
        	boolean gotNimbus = false;
            // Specify Nimbus as the default look and feel for a particular application 
            // at the command line, as follows:
            // java -Dswing.defaultlaf=javax.swing.plaf.nimbus.NimbusLookAndFeel MyApp

            // Permanently set the default look and feel to Nimbus by adding the following
            // line to the <JAVA_HOME>/lib/swing.properties file:
            // swing.defaultlaf=javax.swing.plaf.nimbus.NimbusLookAndFeel
            for (LookAndFeelInfo info : UIManager.getInstalledLookAndFeels()) {
            	// System.out.println( "Application.installLookAndFeel available=" + info.getName());
        	...
        	// System.out.println( "Application.installLookAndFeel system LaF=" + UIManager.getSystemLookAndFeelClassName());
        	if (!gotNimbus)
    ...
    protected JDialog getUncaughtExceptionDialog() {
        ...
        JOptionPane optionPane = new JOptionPane(
                MessageFormat.format(text, getApplicationName()), 
    ...
    protected JDialog createBackgroundThreadDialog() {
        JDialog dialog = new JDialog((Frame)null, getApplicationName(), true);
